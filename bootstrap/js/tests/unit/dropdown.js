$(function () {
  ...
  QUnit.test('should not open dropdown if target is disabled via attribute', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        '<div class="dropdown">' +
        '<button disabled href="#" class="btn dropdown-toggle" >Dropdown</button>' +
    ...
    var $dropdown = $('#qunit-fixture').find('[]').bootstrapDropdown()
  ...
  QUnit.test('should not add class position-static to dropdown if boundary not set', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        ...
        '</div>' +
        '</div>'
    var $dropdown = $(dropdownHTML).find('[]').bootstrapDropdown()
    $dropdown
      .parent('.dropdown')
  ...
  QUnit.test('should add class position-static to dropdown if boundary not scrollParent', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        '<div class="dropdown">' +
        '<a href="#" class="dropdown-toggle"  data-boundary="viewport">Dropdown</a>' +
        '<div class="dropdown-menu">' +
        '<a class="dropdown-item" href="#">Secondary link</a>' +
        '<a class="dropdown-item" href="#">Something else here</a>' +
        '</div>' +
  ...
  QUnit.test('should set aria-expanded="true" on target when dropdown menu is shown', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        '<div class="dropdown">' +
        '<a href="#" class="dropdown-toggle"  aria-expanded="false">Dropdown</a>' +
        '<div class="dropdown-menu">' +
        '<a class="dropdown-item" href="#">Secondary link</a>' +
        '<a class="dropdown-item" href="#">Something else here</a>' +
        '<div class="divider"/>' +
  ...
  QUnit.test('should not open dropdown if target is disabled via class', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        '<div class="dropdown">' +
        '<button href="#" class="btn dropdown-toggle disabled" >Dropdown</button>' +
        '<div class="dropdown-menu">' +
        '<a class="dropdown-item" href="#">Secondary link</a>' +
        '<a class="dropdown-item" href="#">Something else here</a>' +
        '<div class="divider"/>' +
  ...
  QUnit.test('should test if element has a # before assuming it\'s a selector', function (assert) {
    ...
    var dropdownHTML = '<div class="tabs">' +
        '<div class="dropdown">' +
        '<a href="/foo/" class="dropdown-toggle" >Dropdown</a>' +
        '<div class="dropdown-menu">' +
        '<a class="dropdown-item" href="#">Secondary link</a>' +
        '<a class="dropdown-item" href="#">Something else here</a>' +
        '<div class="divider"/>' +
  ...
  QUnit.test('should remove "show" class if body is clicked, with multiple dropdowns', function (assert) {
    ...
    var dropdownHTML = '<div class="nav">' +
        ...
        '<a class="dropdown-toggle"  href="#testmenu">Test menu <span class="caret"/></a>' +
        '<div class="dropdown-menu">' +
        ...
        '</div>' +
        '</div>'
    var $dropdowns = $(dropdownHTML).appendTo('#qunit-fixture').find('[]')
  ...
  QUnit.test('should remove "show" class if body if tabbing outside of menu, with multiple dropdowns', function (assert) {
    ...
    var dropdownHTML = '<div class="nav">' +
        ...
        '<div class="btn-group">' +
        '<button class="btn">Actions</button>' +
        '<button class="btn dropdown-toggle" ><span class="caret"/></button>' +
        '<div class="dropdown-menu">' +
        '<a class="dropdown-item" href="#">Action 1</a>' +
        '</div>' +
        '</div>'
  ...
  QUnit.test('Dropdown should not use Popper.js in navbar', function (assert) {
    ...
    var html = '<nav class="navbar navbar-expand-md navbar-light bg-light">' +
        '<div class="dropdown">' +
        '  <a class="nav-link dropdown-toggle" href="#" id="dropdown"  aria-haspopup="true" aria-expanded="false">Dropdown</a>' +
